...
<div class="equation" align="center" data-raw-text="\sigma = \sqrt{\frac{1}{N} \sum_{i=0}^{N-1} (x_i - \mu)^2}" data-equation="eq:population_standard_deviation">
    <img src="https://cdn.rawgit.com/stdlib-js/stdlib/be7d6cd092e1ded03440c876ecd30bea60cf9acc/lib/node_modules/@stdlib/stats/base/nanstdevwd/docs/img/equation_population_standard_deviation.svg" alt="Equation for the population standard deviation.">
    <br>
</div>
...
<div class="equation" align="center" data-raw-text="\mu = \frac{1}{N} \sum_{i=0}^{N-1} x_i" data-equation="eq:population_mean">
    <img src="https://cdn.rawgit.com/stdlib-js/stdlib/be7d6cd092e1ded03440c876ecd30bea60cf9acc/lib/node_modules/@stdlib/stats/base/nanstdevwd/docs/img/equation_population_mean.svg" alt="Equation for the population mean.">
    <br>
</div>
...
<div class="equation" align="center" data-raw-text="s = \sqrt{\frac{1}{n-1} \sum_{i=0}^{n-1} (x_i - \bar{x})^2}" data-equation="eq:corrected_sample_standard_deviation">
    <img src="https://cdn.rawgit.com/stdlib-js/stdlib/be7d6cd092e1ded03440c876ecd30bea60cf9acc/lib/node_modules/@stdlib/stats/base/nanstdevwd/docs/img/equation_corrected_sample_standard_deviation.svg" alt="Equation for computing a corrected sample standard deviation.">
    <br>
</div>
...
<div class="equation" align="center" data-raw-text="\bar{x} = \frac{1}{n} \sum_{i=0}^{n-1} x_i" data-equation="eq:sample_mean">
    <img src="https://cdn.rawgit.com/stdlib-js/stdlib/be7d6cd092e1ded03440c876ecd30bea60cf9acc/lib/node_modules/@stdlib/stats/base/nanstdevwd/docs/img/equation_sample_mean.svg" alt="Equation for the sample mean.">
    <br>
</div>
...
```bash
npm install @stdlib/stats-base-nanstdevwd
```
...
[test-image]: https://github.com/stdlib-js/stats-base-nanstdevwd/actions/workflows/test.yml/badge.svg
[test-url]: https://github.com/stdlib-js/stats-base-nanstdevwd/actions/workflows/test.yml
